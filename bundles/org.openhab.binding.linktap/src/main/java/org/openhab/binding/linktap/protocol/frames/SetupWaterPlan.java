...
import static org.openhab.binding.linktap.protocol.frames.HandshakeResp.DATE_TIME_FORMATTER;
    ...
    public class WaterPlanInstant extends WaterSchedule {
        ...
        public boolean isValid() {
            ...
            if (timestamp.length() != 14)
                return false;
            try {
                LocalDate.parse(timestamp.substring(0, 8), DATE_TIME_FORMATTER);
