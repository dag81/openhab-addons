...
public class TLGatewayFrame implements IPayloadValidator {
    ...
    protected final static int DEFAULT_INT = -1;
     ...
     */
    public static int CMD_ADD_END_DEVICE = 1;
     ...
     */
    public static int CMD_REMOVE_END_DEVICE = 2;
     ...
     */
    public static int CMD_UPDATE_WATER_TIMER_STATUS = 3;
     ...
     *              CMD:13)
     */
    public static int CMD_SETUP_WATER_PLAN = 4;
     ...
     */
    public static int CMD_REMOVE_WATER_PLAN = 5;
     ...
     */
    public static int CMD_IMMEDIATE_WATER_START = 6;
     ...
     */
    public static int CMD_IMMEDIATE_WATER_STOP = 7;
     ...
     */
    public static int CMD_RAINFALL_DATA = 8;
     ...
     */
    public static int CMD_NOTIFICATION_WATERING_SKIPPED = 9;
     ...
     */
    public static int CMD_ALERT_ENABLEMENT = 10;
     ...
     */
    public static int CMD_ALERT_DISMISS = 11;
     ...
     */
    public static int CMD_LOCKOUT_STATE = 12;
     ...
     */
    public static int CMD_DATETIME_SYNC = 13;
     ...
     */
    public static int CMD_DATETIME_READ = 14;
     ...
     */
    public static int CMD_WIRELESS_CHECK = 15;
     ...
     */
    public static int CMD_GET_CONFIGURATION = 16;
     ...
     */
    public static int CMD_SET_CONFIGURATION = 17;
     ...
     *              (0.1 to 240 hours)
     */
    public static int CMD_PAUSE_WATER_PLAN = 18;
}
